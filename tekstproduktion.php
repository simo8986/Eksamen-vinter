      ...
      <div class="card-body">
        <h3>De fem nyhedskriterier:</h3>
                <ol>
                    ...
                    <li>Konflikt: Ligger der en konflikt gemt, som er værd at grave i?</li>
                    <li>Identifikation: Kan læseren identificere sig med indholdet? </li>
                    <li>Aktualitet: Er det reelt set aktuelt, og vigtigt nu og her?</li>
                </ol>
            <p>Jo flere nyhedskriterier en tekst lever op til, jo mere relevant er den.</p>
            
            <h3>Inddeling af stof</h3>
            <p>Overordnet set kan man inddele stof i 3 kategorier</p>
                <ol>
                    <li>Oplysning/Information</li>
                    <li>Debat</li>
                    <li>Underholdning</li>
                </ol>
            <p>De kan underdeles igen ud fra hvilken slags indhold det er. Om det er Information(Objektiv) eller opinion(Subjektiv).</p>
        
            <h3>Kilder</h3>
            <p>Man skal altid angive kilder, og man skal passe på med at bruge;</p>
                <ul>
                    <li>Kilder man ikke kan tjekke, fx andenhåndsviden fra internettet, eller anonym forfatter. </li>
                    <li>Kilder, man har en fælles interesse med, Det kan gøre det svært at være objektiv. Man skal se sagen fra alle sider.</li>
                    <li>Kilder man personligt godt kan lide, det er svært at være kritisk hvis man har et personligt forhold til dem man skriver om. </li>
                </ul>
        
            <h3>Billeder</h3>
            <p>Der er to kategorier</p>
                <ul>
                    <li>Virkelige billeder: Det man ser har været foran kameraet og bruges ofte som reportage billeder eller dokumentation.</li>
                    <li>Arrangerede billeder: Det man ser har ikke været foran kameraet. Fx manipulerede billeder, eller illustrationer. </li>
                </ul>
            
            <h3>Opsætning</h3>
            <p>De fagtermer journalister bruger når de taler om tekstens opsætning.</p>
            <p>Rubrik: Det man kalder overskriften. Det skal dække for indholdet, og vække nysgerrighed. Det skal være fangende, informativt og kort. Nogen bruger også underrubrik, altså en underoverskrift. </p>
            <p>Trompet: Trompeten er en overlinje, der er en slags vejviser. Den kan eksempelvis sige noget om hvor vi er henne i verden, eller hvilken sportsgren det handler om.</p>
            <p>Manchet: Under overskriften, et referat af hele teksten eller en formuleret konklusion. Den er større end en underrubrik, men grænsen mellem dem er flydende.</p>
      ...
      <div class="card-body">
        <p>Det er ekstremt vigtigt at strukturere indholdet i en brochure grundigt, med rigtig mange overvejelser omkring typografi og billeder. Elementerne skal arbejde sammen for at fremstå troværdigt i forhold til ens budskab. Her er et eksempel på hvordan man kan opbygge sin brochure fra bogen ’Kommunikation i multimediedesign’, kapitel 17 tekstproduktion. De fokuserer på en lampeforretning. </p>
            <ul>
                ...
                <li>Produkt/emne: Brochuren skal positionere vores lampedesign.</li>
                <li>Stilvalg for tekst og visuelt design: Vi vil sælge stemning, vi vil vise lampernes eksklusivitet og elegance i omgivelser, som tiltaler målgruppen.</li>
                <li>Medieformatets detaljer: Formatet er fire A5 sider, farvetryk.</li>
                <li>Distribution: Brochuren skal lægges synligt i alle vores butikker.</li>
                <li>Informationsarkitektur: Forside: Brochurens forside skal have et flot billeder, der sælger drømmen! Tydeligt logo, men ikke for stort og dominerende. </li>
      ...
      <div class="card-body">
        ...
        <p>Her er nogle gode råd at følge:</p>
            <ul>
                ...
                <li>Vær bevist om:</li>
                    <ul>
                        <li>Modtager: Hvem skal vide hvad?</li>
                        <li>Afsender: Hvordan målretter jeg mig sprog og mine budskaber til brugerne?</li>
                        <li>Formål og mål: Hvad er mit overordnede formål med mit site, og hvad er mine mål. </li>
      ...
      <div class="card-body">
        ...
        <p>Man kan bruge tekststrategien Försters temperamentale rose, som er inddelt i farvegrupperne:</p>
            <ul>
                ...
                <li>Grøn: er symbolsk for garantier og kvalitet. Den fokuserer på orden, kvalitet, garantier og tradition.</li>
                <li>Gul: Er symbolsk for oplevelser. Fokuserer på visioner, ideer, sjov, spontanitet og oplevelser. </li>
