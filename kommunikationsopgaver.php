...
<div class="accordiongrid"> 
  ...
  <div class="card">
    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
      <div class="card-body">
        <p>Her skulle vi udfylde et business model canvas til flyrejsefirmaet RyanAir. Mig, Erin og René lavede følgende:</p>
            <img src="billeder/kommunikation/bmc1.jpg" alt="Business Model Canvas til RyanAir version 1">
            <p>Derefter kombinerede vi det med en anden gruppes, og fik følgende:</p>
            <img src="billeder/kommunikation/bmc2.jpg" alt="Business Model Canvas til RyanAir version 2">
      </div>
    </div>
  </div>
</div>        
