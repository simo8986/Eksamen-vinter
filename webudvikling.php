...
<html lang="da">
  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        <h3>Afsnit (paragraph)</h3>
          <p><code>&lt;p&gt;&lt;/p&gt;</code>, Semantisk. Starter og slutter et afsnit</p>
            <h3>Indeling (division)</h3>
          <p><code>&lt;div&gt;&lt;/div&gt;</code>, ikke semantisk. Laver en inddeling.<br>Brug andre tags end 	&lt;div&gt; så ofte som muligt, fordi det ikke er semantisk.</p>
            <h3>Område</h3>
          <p><code>&lt;span&gt;&lt;/span&gt;</code>, minder om <code>&lt;div&gt;</code> og <code>&lt;p&gt;</code>, men medfører ikke linjeskift.</p>
            <h3>Section</h3>
          <p><code>&lt;section&gt;&lt;/section&gt;</code>, semantisk. Fortæller at alt derimellem hører sammen.</p>
            <h3>Ordnede og uordnede lister</h3>
          <p><code>&lt;ol&gt;&lt;/ol&gt;</code> = Ordnede lister, nummereret.</p>
          <p><code>&lt;ul&gt;&lt;/ul&gt;</code> = Uordnede lister, ikke nummereret.</p>
          <p><code>&lt;li&gt;&lt;/li&gt;</code> = List element.</p>
                <p>Når man ligger et element inden i et element, er det et 'nested' ellement.</p>
            <h3>Link</h3>
          <p><code>&lt;a href=""&gt;&lt;/a&gt;</code></p>
                <p>anchortag = a</p>
                <p>Med attributten 'hyper refference' = <code>href</code></p>
            ...
            <h3>Billede</h3>
                ...
                <p>Man bør ikke udfylde højde og bredde med html, kun definere for aspect ratio.<br>
                Normaltvis definere man kun enten højde, eller bredde. Ellers bliver det ikke proportionelt.<br>
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
        <p>CSS = Cascading Style Sheets. Cascading henviser til regler for hvornår hvilke styles gælder.<br>Det gør det muligt at adskille struktur og udseende.<br>Et "stylesheet" er en samling af "rules". "Styles" angives som "rules" som kan navigeres, og refereres i HTML</p>
            <h3>Kan placeres i</h3>
                <ul>
                    <li>Dokumentet (embed). Gælder kun for dokumentet. Placeres i <code>&lt;head&gt;</code> med <code>&lt;style&gt;&lt;/style&gt;</code></li>
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
        <p>En af de nyeste specifikationer i CSS-standarden.<br>Ses som det mest revolutionerende siden responsivt webdesign.<br>Det er ikke fuldt understøttet endnu i alle browsere, men næsten. MS EDGE mangler, men er på vej.</p>
        <p>Grid er på forældreleementets container, og regner selv bredde ud.<br>Man bruger fr, som er en ny måleenhed der betyder fractions. 1fr = en fjerdedel. 3fr = 3 fjerdedele. </p>
